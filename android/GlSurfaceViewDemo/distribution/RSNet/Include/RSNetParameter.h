...
typedef struct {
	...
	BYTE CloudPicUpload; 
	BYTE CloudVideoUpload; /* 云存储视频上传 */	
	BYTE SnapModel;			/*人脸：抓拍模式，0:实时模式，1:实时高级模式，2：最优模式，3：最优高级模式，4：间隔抓拍，5：间隔抓拍高级模式
							             *人体：抓拍模式，0:默认模式，1:实时模式，2：间隔模式
									   */
	BYTE FaceType;			/*人脸模式，0:正脸模式，1:多角度模式， 2：自定义*/
	BYTE RollRange;			/*高级模式下，人脸旋转角度,范围0~180，正脸默认30，多角度默认：180*/
	BYTE PitchRange;		/*高级模式下，人脸俯仰角度,范围0~180，正脸默认30，多角度默认：180*/
	BYTE YawRange;			/*高级模式下，人脸侧脸角度,范围0~180，正脸默认45，多角度默认：180*/
	BYTE BlurStage;			/*高级模式下，人脸模糊程度, 范围0~100, 正脸默认为100，多角度默认：100*/
	WORD MinPixel;         /*高级模式，人脸检测最小像素， 范围32-1080，正脸默认64，多角度默认：32*/
...
typedef struct {
	...
	/*
	  针对定时巡航计划，1个字节共8位，按bit取位 bit 0 随机扫描计划，  bit 1为巡航计划，	bit2为花样扫描计划，bit3为预置点巡航计划，bit 4为球机重启，bit 5为球机校验，后几位保留
